...
public class TrainerProfileFragment extends Fragment {
    ...
    private void callApi() {
        ...
        try {
            jsonObject.put("AvailableFrom", "07:00");
            jsonObject.put("AvailableTo", "10:00");
            jsonObject.put("Monday", true);
            jsonObject.put("Tuesday", true);
            jsonObject.put("Wednesday", true);
            jsonObject.put("Thursday", true);
            jsonObject.put("Friday", true);
            jsonObject.put("Saturday", true);
